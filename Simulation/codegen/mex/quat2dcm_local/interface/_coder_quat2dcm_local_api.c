 ...
 *
 * _coder_quat2dcm_local_api.c
 *
 * Code generation for function '_coder_quat2dcm_local_api'
 *
 */
...
void quat2dcm_local_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  quat2dcm_local(&st, *q, *R);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*R);
}

/* End of code generation (_coder_quat2dcm_local_api.c) */
