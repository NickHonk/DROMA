 ...
 *
 * _coder_dcm2quat_local_api.c
 *
 * Code generation for function '_coder_dcm2quat_local_api'
 *
 */
...
void dcm2quat_local_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  dcm2quat_local(&st, *R, *q);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*q);
}

/* End of code generation (_coder_dcm2quat_local_api.c) */
