...
## 
## Makefile     : mcu.mk
## Generated on : Tue Jul 14 11:39:21 2026
...
START_DIR                 = C:\Users\Rakete\Documents\Drohnenversuchsstand\DROMA\Simulation\hardware\mcu_arm
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
SRCS = $(START_DIR)\mcu_ert_rtw\mcu.cpp $(START_DIR)\mcu_ert_rtw\mcu_data.cpp

MAIN_SRC = $(START_DIR)\mcu_ert_rtw\ert_main.cpp
...
{$(START_DIR)\mcu_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\mcu_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\mcu_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\mcu_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\mcu_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\mcu_ert_rtw\ert_main.cpp"


mcu.obj : "$(START_DIR)\mcu_ert_rtw\mcu.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\mcu_ert_rtw\mcu.cpp"


mcu_data.obj : "$(START_DIR)\mcu_ert_rtw\mcu_data.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\mcu_ert_rtw\mcu_data.cpp"
