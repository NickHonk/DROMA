...
## 
## Makefile     : mcu.mk
## Generated on : Fri Jul 10 10:49:16 2026
...
START_DIR                 = C:/Users/Nick/THESIS~1/MASVER~1/Drohnen/DROMA/SIMULA~1/hardware/mcu_arm
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
%.obj : $(START_DIR)/mcu_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/mcu_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/mcu_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/mcu_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
