...
## 
## Makefile     : mcu.mk
## Generated on : Mon Jul 13 11:54:15 2026
## Final product: ./mcu_rtwlib.lib
...
SRCS = $(START_DIR)/slprj/ert/mcu/mcu.cpp $(START_DIR)/slprj/ert/mcu/mcu_data.cpp
...
%.obj : $(START_DIR)/slprj/ert/mcu/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
mcu.obj : $(START_DIR)/slprj/ert/mcu/mcu.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


mcu_data.obj : $(START_DIR)/slprj/ert/mcu/mcu_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
