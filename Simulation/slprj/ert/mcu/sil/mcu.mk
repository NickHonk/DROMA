...
## 
## Makefile     : mcu.mk
## Generated on : Tue Jul 07 17:17:07 2026
## Final product: ./mcu.exe
...
COMPILER_COMMAND_FILE     = mcu_comp.rsp
CMD_FILE                  = mcu.rsp
...
MODELREF_LIBS = C:/Users/Nick/THESIS~1/MASVER~1/Drohnen/DROMA/SIMULA~1/slprj/ert/mcu/MCU_RT~1.LIB

LIBS = $(START_DIR)/slprj/ert/_sharedutils/rtwshared.lib $(START_DIR)/slprj/ert/mcu/coderassumptions/lib/mcu_ca.lib
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) -Wl,--start-group @$(MODELREF_LINK_RSPFILE) $(LIBS) -Wl,--end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
xil_interface.obj : $(START_DIR)/slprj/ert/mcu/sil/xil_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/slprj/ert/mcu/sil/sil_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
