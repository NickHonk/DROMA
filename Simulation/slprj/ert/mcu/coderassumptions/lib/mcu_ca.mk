...
START_DIR                 = C:/Users/Nick/THESIS~1/MASVER~1/Drohnen/DROMA/SIMULA~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = mcu_ca_comp.rsp
CMD_FILE                  = mcu_ca.rsp
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/slprj/ert/mcu/coderassumptions/mcu_ca.c
...
OBJS = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj mcu_ca.obj
...
%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/lib/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/lib/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/lib/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
mcu_ca.obj : $(START_DIR)/slprj/ert/mcu/coderassumptions/mcu_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"
