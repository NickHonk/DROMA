###########################################################################
## Makefile generated for component 'quatConj'. 
## 
## Makefile     : quatConj_rtw.mk
## Generated on : Tue Jul 14 11:44:19 2026
## Final product: .\quatConj.lib
...
PRODUCT_NAME              = quatConj
MAKEFILE                  = quatConj_rtw.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2025b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2025b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Rakete\Documents\Drohnenversuchsstand\DROMA\Simulation\scripts\sitl\codegen\lib\quatConj
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = quatConj_rtw_comp.rsp
CMD_FILE                  = quatConj_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = quatConj.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=quatConj
...
SRCS = $(START_DIR)\quatConj_initialize.c $(START_DIR)\quatConj_terminate.c $(START_DIR)\quatConj.c
...
OBJS = quatConj_initialize.obj quatConj_terminate.obj quatConj.obj
...
quatConj_initialize.obj : "$(START_DIR)\quatConj_initialize.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quatConj_initialize.c"


quatConj_terminate.obj : "$(START_DIR)\quatConj_terminate.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quatConj_terminate.c"


quatConj.obj : "$(START_DIR)\quatConj.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quatConj.c"
