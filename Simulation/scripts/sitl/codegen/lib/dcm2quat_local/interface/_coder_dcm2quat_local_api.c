 ...
 * File: _coder_dcm2quat_local_api.c
 *
...
void dcm2quat_local_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  R = emlrt_marshallIn(&st, emlrtAlias(prhs), "R");
  /* Invoke the target function */
  dcm2quat_local(*R, *q);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*q);
}
...
void dcm2quat_local_atexit(void)
{
  ...
  dcm2quat_local_xil_terminate();
  dcm2quat_local_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_dcm2quat_local_api.c
 *
 * [EOF]
 */
