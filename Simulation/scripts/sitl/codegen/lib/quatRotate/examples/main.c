 ...
 * Return Type  : void
 */
void main_quatRotate(void)
{
  double dv[4];
  double dv1[3];
  double vb[3];
  /* Initialize function 'quatRotate' input arguments. */
  /* Initialize function input argument 'q'. */
  /* Initialize function input argument 'vn'. */
  /* Call the entry-point 'quatRotate'. */
  argInit_4x1_real_T(dv);
  argInit_3x1_real_T(dv1);
  quatRotate(dv, dv1, vb);
}
