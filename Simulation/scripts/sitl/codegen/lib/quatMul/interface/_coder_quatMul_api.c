 ...
 * File: _coder_quatMul_api.c
 *
 * MATLAB Coder version            : 25.2
 * C/C++ source code generated on  : 14-Jul-2026 11:44:17
 */

/* Include Files */
#include "_coder_quatMul_api.h"
#include "_coder_quatMul_mex.h"
...
void quatMul_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  c = emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "c");
...
void quatMul_atexit(void)
{
  ...
  quatMul_xil_terminate();
  quatMul_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_quatMul_api.c
 *
 * [EOF]
 */
