###########################################################################
## Makefile generated for component 'quatMul'. 
## 
## Makefile     : quatMul_rtw.mk
## Generated on : Tue Jul 14 11:44:18 2026
## Final product: .\quatMul.lib
...
PRODUCT_NAME              = quatMul
MAKEFILE                  = quatMul_rtw.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2025b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2025b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Rakete\Documents\Drohnenversuchsstand\DROMA\Simulation\scripts\sitl\codegen\lib\quatMul
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = quatMul_rtw_comp.rsp
CMD_FILE                  = quatMul_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = quatMul.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=quatMul
...
SRCS = $(START_DIR)\quatMul_initialize.c $(START_DIR)\quatMul_terminate.c $(START_DIR)\quatMul.c
...
OBJS = quatMul_initialize.obj quatMul_terminate.obj quatMul.obj
...
quatMul_initialize.obj : "$(START_DIR)\quatMul_initialize.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quatMul_initialize.c"


quatMul_terminate.obj : "$(START_DIR)\quatMul_terminate.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quatMul_terminate.c"


quatMul.obj : "$(START_DIR)\quatMul.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quatMul.c"
