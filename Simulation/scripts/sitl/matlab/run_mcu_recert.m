...
% run_mcu_recert — §3b: mcu.slx (throttle-Outport) neu generieren, throttle-
% Polynom fuer die Host-Invariante dumpen, Golden neu aufzeichnen. Headless.
...
fprintf(fid,'// GENERIERT von run_mcu_recert.m aus quadcop.p_from_omega_sq — NICHT editieren.\n');
...
fprintf('\n== FERTIG Regen+Golden. Naechster Schritt: Gate A (sil_check_mcu), Gate B (ctest). ==\n');
end
