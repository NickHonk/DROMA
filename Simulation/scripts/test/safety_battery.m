...
%
% Kette:  ADC-count --(2-Punkt-Cal k,b)--> V_batt --(tau)--> V_filt
%         V_filt --(3-stufige LED, Hysterese)--> led
%         V_filt <= V_floor --(Latch, sticky bis Reboot)--> batt_land
%
...
%   2) WICHTIGER: Im Descent faellt der Schub auf 0.92*m*g -> weniger Strom ->
